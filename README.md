...
A simple yet powerful AI-powered web app that takes any news article or blog post and summarizes it into 3 concise sentences — built using Hugging Face Transformers, Streamlit.
